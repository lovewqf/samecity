...
class TongchengDownloaderMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        # if spider.name == 'same_city':
        #     browser = webdriver.Chrome()
        #     browser.get(request.url)
        #     browser.find_element_by_id('pwdLogin').click()
        #     time.sleep(2)
        #     browser.find_element_by_id('usernameUser').send_keys('yin18339443137')
        #     time.sleep(2)
        #     print('aaa')
        #     # browser.find_element_by_id('passwordUserText').send_keys('feng123456')
        #     # time.sleep(2)
        #     print('bbb')
        #     third_mark = browser.find_element_by_id('btnSubmitUser')
        #     third_mark.click()
        #     time.sleep(3)
        #     print('请走我这一步')
